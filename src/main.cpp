...
uint256 hashGenesisBlock("0x431ace9d71ee11d8d0e5b99fd21bd3798565f4d13d97c57f8a2d28c3f5b2b74a");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // cashtag: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "cashtag Signed Message:\n";
...
{
    // cashtag: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // cashtag: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // cashtag: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // cashtag: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x431ace9d71ee11d8d0e5b99fd21bd3798565f4d13d97c57f8a2d28c3f5b2b74a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1397555329;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086931432;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("cashtagMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("cashtagMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running cashtag with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("cashtagMiner terminated\n");
        throw;
    }
}
